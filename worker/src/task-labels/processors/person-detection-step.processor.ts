...
> {
  ...
  private labelMediaMutator: LabelMediaMutator;
  ...
  constructor(
    ...
    super();
    this.labelClipMutator = this.pocketBaseService.labelClipMutator;
    this.labelTrackMutator = this.pocketBaseService.labelTrackMutator;
    this.labelMediaMutator = this.pocketBaseService.labelMediaMutator;
  }
